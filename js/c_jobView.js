             ...
             divDetails ='<div class="post-content box" id="post_single" style="height:400px;">'+
                  '<div class="post-container" style="padding-bottom:0px;">'+
                      ...
                      '<div class="post-detail">'+
                          '<div class="user-info">'+
                              '<h4  style="text-transfrom:capitalize;margin:0px"><a href="#" class="profile-link follow_rec" name="'+det[d].r_id+'" id="'+det[d].r_compname+'">'+det[d].r_compname+'</a> </h4>'+
...
// FOLLOW PAGE
$(document).on('click', '.follow_rec', function(){
var rf_id;
    ...
    var rec;
    var recDiv;
    rf_id = $(this).attr('name')
    var cnm = $(this).attr('id')
    // console.log(cnm)
    // console.log(rid)
    // $("#myModal").modal('show')
    window.location.href="follow.html?company_name="+encodeURIComponent(cnm)+"&r_id="+encodeURIComponent(rf_id) ;
